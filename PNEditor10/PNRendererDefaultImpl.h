#ifndef PNRENDERERDEFAULTIMPL_H

///////////////////////////////////////////////////////////////////////////////
/// \file
/// \brief Contains PNRendererDefaultImpl implementation.
/// \author Oleg Bulanov
/// \version 0.1.0
/// \date 04.08.2014
///////////////////////////////////////////////////////////////////////////////

#define PNRENDERERDEFAULTIMPL_H
...
/** \brief Default PetriNet renderer 
*   
*  
*/
class PNRendererDefaultImpl : public IVTMinePNRenderer
{
public:
    ...
    *   
    *  Transition is represented as rectangle
    */
    ...
    private:
        //QRectF                      _coord;         ///< Coord rectangle
        QRectF                      _rec;           ///< Bounding rectangle
        IPNBaseData::IPNBaseDataPtr _data;          ///< Data of Transition
...
public:
    PNRendererDefaultImpl() { _id = "0"; _name = "DefaultRenderer"; }
