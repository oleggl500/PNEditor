...
//-----------------------------------------------------------------------------
PNRendererDefaultImpl::PositionGrItem::PositionGrItem(IPNBaseData::IPNBaseDataPtr data, QRectF& coord)
{
...
//-----------------------------------------------------------------------------
QRectF PNRendererDefaultImpl::PositionGrItem::boundingRect() const
{
    return _rec;
}
...
//-----------------------------------------------------------------------------
QPainterPath PNRendererDefaultImpl::PositionGrItem::shape() const
{
    QPainterPath path;
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::PositionGrItem::paint(QPainter* painter, const QStyleOptionGraphicsItem* op, QWidget* wg)
{
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::PositionGrItem::setCoord(QRectF& coord)
{
    _rec = QRectF(coord.x(), coord.y(), _posSize, _posSize);
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::PositionGrItem::setData(IPNBaseData::IPNBaseDataPtr data)
{
    _data = data;
}
...
//-----------------------------------------------------------------------------
const IPNBaseData::IPNBaseDataPtr& PNRendererDefaultImpl::PositionGrItem::getData()
{
    return _data;
}
...
//-----------------------------------------------------------------------------
QRectF PNRendererDefaultImpl::PositionGrItem::getCoord()
{
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::PositionGrItem::selectItem ()
{
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::PositionGrItem::selectOutItem ()
{
    _brush.setColor(Qt::white);
    update();
}
...
//-----------------------------------------------------------------------------
QPointF PNRendererDefaultImpl::PositionGrItem::center()
{
    return _rec.center();
}
...
//-----------------------------------------------------------------------------
PNRendererDefaultImpl::TransitionGrItem::TransitionGrItem(IPNBaseData::IPNBaseDataPtr data, QRectF& coord)
{
...
QRectF PNRendererDefaultImpl::TransitionGrItem::boundingRect() const
{
    return _rec;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::TransitionGrItem::paint(QPainter* painter, const QStyleOptionGraphicsItem* op, QWidget* wg)
{
    painter->setOpacity(1);
    painter->setPen(_pen);
    painter->setBrush(_brush);
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::TransitionGrItem::setCoord(QRectF& coord)
{
    _rec = QRectF(coord.x(), coord.y(), _transWidth, _transHeight);
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::TransitionGrItem::setData(IPNBaseData::IPNBaseDataPtr data)
{
    _data = data;
}
...
//-----------------------------------------------------------------------------
const IPNBaseData::IPNBaseDataPtr& PNRendererDefaultImpl::TransitionGrItem::getData()
{
    return _data;
}
...
// Returns coordinates of the PositionGrItem
//-----------------------------------------------------------------------------
QRectF PNRendererDefaultImpl::TransitionGrItem::getCoord()
{
    auto topLeft =  scenePos() + _rec.topLeft(); 
    return QRectF(topLeft.x(),topLeft.y(),_rec.width(), _rec.height());
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::TransitionGrItem::selectItem ()
{
    _brush.setColor(Qt::blue);
    update();
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::TransitionGrItem::selectOutItem ()
{
    _brush.setColor(Qt::white);
    update();
}
...
//-----------------------------------------------------------------------------
QPointF PNRendererDefaultImpl::TransitionGrItem::center()
{
    return _rec.center();
}
...
//-----------------------------------------------------------------------------
PNRendererDefaultImpl::EdgeGrItem::EdgeGrItem(EdgeCoords coords, IPNBaseData::IPNBaseDataPtr data)
{
...
//-----------------------------------------------------------------------------
PNRendererDefaultImpl::EdgeGrItem::EdgeGrItem(PositionGrItem* pos, TransitionGrItem* trans, IPNBaseData::IPNBaseDataPtr data)
{
    _pikeLength = pikeDefaultLength;
    _pikeAngle = pikeDefaultAngle;
    _shapeEps = shapeDefaultEps;
...
//-----------------------------------------------------------------------------
PNRendererDefaultImpl::EdgeGrItem::EdgeGrItem(TransitionGrItem* trans, PositionGrItem* pos, IPNBaseData::IPNBaseDataPtr data)
{
    _pikeLength = pikeDefaultLength;
    _pikeAngle = pikeDefaultAngle;
    _shapeEps = shapeDefaultEps;
...
//-----------------------------------------------------------------------------
QPainterPath PNRendererDefaultImpl::EdgeGrItem::shape() const
{
    return _shape;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::setCoords(EdgeCoords coords)
{
    _coords = coords;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::setPos(IPositionGrItem* pos)
{
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::setTrans(ITransitionGrItem* trans)
{
    if(_dir != fromPointToPoint)
        _trans = trans;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::setData(IPNBaseData::IPNBaseDataPtr data)
{
    _data = data;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::setDir(Dir dir)
{
    _dir = dir;
}
...
//-----------------------------------------------------------------------------
EdgeCoords PNRendererDefaultImpl::EdgeGrItem::getCoords()
{
    return _coords;
}
...
//-----------------------------------------------------------------------------
IPNBaseData::IPNBaseDataPtr PNRendererDefaultImpl::EdgeGrItem::getData()
{
    return _data;
}
...
//-----------------------------------------------------------------------------
IVTMinePNRenderer::IPositionGrItem* PNRendererDefaultImpl::EdgeGrItem::getPos()
{
    return _pos;
}
...
//-----------------------------------------------------------------------------
IVTMinePNRenderer::ITransitionGrItem* PNRendererDefaultImpl::EdgeGrItem::getTrans()
{
    return _trans;
}
...
//-----------------------------------------------------------------------------
IVTMinePNRenderer::IEdgeGrItem::Dir PNRendererDefaultImpl::EdgeGrItem::getDir()
{
    return _dir;
}
...
//-----------------------------------------------------------------------------
void PNRendererDefaultImpl::EdgeGrItem::rearrange()
{
...
QPointF PNRendererDefaultImpl::EdgeGrItem::posContact()
{
    if(_dir == fromPointToPoint)
        return QPointF();
    QPointF posCenter;
    ...
    transCenter = _trans->scenePos() + _trans->center();
...
QPointF PNRendererDefaultImpl::EdgeGrItem::transContact()
{
    if(_dir == fromPointToPoint)
        return QPointF();
    QPointF posCenter;
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createPosGraphicsItem(PositionWithPtr* pos) const
{
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createPosGraphicsItem(PositionWithPtr* pos, QRectF coords) const
{
...
//-----------------------------------------------------------------------------
QRectF PNRendererDefaultImpl::makePosCoordsList(QGraphicsItem* gri) const 
{
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createTransGraphicsItem(TransitionWithPtr* trans) const
{
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createTransGraphicsItem(TransitionWithPtr* trans, QRectF coords) const
{
...
//-----------------------------------------------------------------------------
QRectF PNRendererDefaultImpl::makeTransCoordsList(QGraphicsItem* gri) const 
{
...
// with the given data
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createEdgeGraphicsItem(EdgeCoords coords, IPNBaseData::IPNBaseDataPtr data)
{
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createEdgeGraphicsItem(EdgeWithPtr* edge, QGraphicsItem* posGrItem, QGraphicsItem* transGrItem)
{
...
//-----------------------------------------------------------------------------
QGraphicsItem* PNRendererDefaultImpl::createEdgeGraphicsItem(EdgeWithPtr* edge, QGraphicsItem* posGrItem, QGraphicsItem* transGrItem, EdgeCoords coords)
{
...
//-----------------------------------------------------------------------------
EdgeCoords PNRendererDefaultImpl::makeEdgeCoordsList(QGraphicsItem* gri) const
{
